    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        try {
          ...
          try { body = JSON.parse(rawBody) as Partial<AnalyzeInput>; }
          ...
          Object.assign(metadata, {
            ...
            freshness: 'الآن',
            caveat: indexedCount ? 'بعض الأدلة جاءت من فهارس بحث عامة لأن بعض المواقع تمنع الوصول الآلي. لم يتم تجاوز أي حماية؛ الأدلة المفهرسة مميزة عن الزيارة المباشرة.' : 'المصادر المتاحة تمت قراءتها مباشرة.',
          });
          ...
          try {
            ...
            try {
              ...
              metadata['evidenceLedgerError'] = 'تعذّر حفظ سجل الأدلة.';
            }
          } catch (error) {
